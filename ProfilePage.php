...
if(isset($_SESSION['userid']))
{
  ...
  echo ("<div style='position:relative; background-color:rgba(40, 40, 40, .7); width:40%; left:20px; top:20px; height:200px;'>");
...
if (isset($_SESSION["isPatron"])) {
  echo ("<div style='position:absolute; width: 40%; left:20px; height: calc(90% - 220px); bottom:20px; overflow-y: scroll;'>");
...
<div style='position: absolute; left:60%; right:20px; top:20px; height:90%'>
