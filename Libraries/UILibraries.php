...
function GetTheirBanishForDisplay($playerID)
{
  ...
  for ($i = 0; $i < count($theirBanish); $i += BanishPieces()) {
    if ($theirBanish[$i + 1] == "INT" || $theirBanish[$i + 1] == "UZURI" || $theirBanish[$i + 1] == "NTSTONERAIN" || $theirBanish[$i + 1] == "STONERAIN" || $theirBanish[$i + 1] == "TRAPDOOR") array_push($banish, $TheirCardBack);
...
function GetMyBanishForDisplay($playerID)
{
  ...
  for ($i = 0; $i < count($myBanish); $i += BanishPieces()) {
    if ($myBanish[$i + 1] == "INT" || $myBanish[$i + 1] == "UZURI" || $myBanish[$i + 1] == "NTSTONERAIN" || $myBanish[$i + 1] == "STONERAIN" || $myBanish[$i + 1] == "TRAPDOOR") array_push($banish, $myCardBack);
