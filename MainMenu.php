...
<div class="CreateGame_Menu">
  ...
  <?php
  if (isset($_SESSION["userid"])) {
    echo ("<label for='gameKarmaRestriction' style='font-weight:bolder; margin-left:10px;'>Restrict by Reputation:</label>");
    echo ("<select class='karmaRestriction-Select' name='gameKarmaRestriction' id='gameKarmaRestriction'>");
      ...
      if ($_SESSION["userKarma"] >= 75) echo ("<option value='75'>☯ ≥ 75% - Only players with a good reputation.</option>");
