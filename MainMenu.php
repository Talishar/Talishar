...
?>
<h5>Talishar is an open-source, fan-made platform not associated with LSS. It may not be a completely accurate
    representation of the Rules as Written. If you have questions about interactions or rulings, please <a
            style='text-decoration: underline;' target='_blank' href='https://discord.gg/VFhYB9T7s8'>contact the judge
        community</a> for clarification.</h5>

<h1><?php echo($createNewGameText); ?></h1>
<h2 style='width:60%; color: orange; margin: auto;'>

    This is the Legacy UI. It is no longer supported. Please download the <b><a
                href="https://github.com/Talishar/Talishar-FE">Talishar Front End</a></b> and follow the README. Failure
...
?>
<label for="private">
    <input type="radio" class='SelectDeckInput' id="private" name="visibility"
           value="private" <?php if ($defaultVisibility == 0) echo 'checked="checked"'; ?> />
    Private</label>
...
<div class="ContentWindow"
     style='right:20px; top:60px; bottom:30px; width:27%; <?php if (IsMobile()) echo("display:none; "); ?>'>
    <h1>News</h1>
    <div style="position: relative;">
        <div style='vertical-align:middle; text-align:center;'>
            <h3>This is the old version of the site and is no longer supported, go to <a style='color:blue'
                                                                                         href='https://talishar.net'>talishar.net</a>
            </h3>
        </div>
    </div>
  <?php
