...
enum PatreonCampaign : string
{
  ...
  public function SessionID(): string
  {
    switch($this->value)
    {
      ...
      case "35223304": return "isDazzyfizzlePatron";
      default: return "";
    }
  }
  ...
  public function CampaignName(): string
  {
    switch($this->value)
    {
      ...
      case "35223304": return "Dazzyfizzle";
      default: return "";
    }
  }
  ...
  public function IsTeamMember($userName): string
  {
    switch($this->value)
    {
      ...
      case "35223304": return ($userName == "PvtVoid" || $userName == "dazzyfizzle" || $userName == "OotTheMonk");
      default: return "";
    }
  }
