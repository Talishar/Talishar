...
CREATE TABLE `users` (
  ...
  `metafyTokenExpires` TIMESTAMP NULL DEFAULT NULL,
  `metafyScopes` VARCHAR(255) DEFAULT NULL,
  `metafyLastSync` TIMESTAMP NULL DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS hero_mastery (
  ...
  displayLevel TINYINT UNSIGNED NULL DEFAULT NULL,
