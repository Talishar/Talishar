...
function AttackModifier($cardID, $from = "", $resourcesPaid = 0, $repriseActive = -1)
{
  ...
  global $combatChain, $CS_Transcended, $CS_NumBluePlayed, $CS_NumLightningPlayed, $CS_DamageDealt, $CS_NumCranked;
  ...
  switch ($cardID) {
    ...
    case "ROS102":
    case "ROS103":
      return (GetClassState($mainPlayer, $CS_DamageDealt)) > 0 ? 1 : 0;
    case "ROS134":
    case "ROS135":
    case "ROS136":
      return GetClassState($defPlayer, $CS_ArcaneDamageTaken) > 0 ? 2 : 0;
