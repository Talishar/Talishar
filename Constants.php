...
$CCS_CurrentAttackGainedDominate = 48;
...
{
  global $combatChainState, $CCS_CurrentAttackGainedGoAgain, $CCS_CurrentAttackGainedDominate, $CCS_WeaponIndex, $CCS_DamageDealt;
  ...
  $combatChainState[$CCS_CurrentAttackGainedDominate] = 0;
...
function AttackReplaced($cardID, $player)
{
  ...
  global $CCS_CurrentAttackGainedGoAgain, $CCS_CurrentAttackGainedDominate, $CCS_GoesWhereAfterLinkResolves, $CCS_AttackPlayedFrom, $CCS_LinkBasePower, $combatChain;
...
{
  global $combatChainState, $CCS_CurrentAttackGainedGoAgain, $CCS_CurrentAttackGainedDominate, $CCS_WeaponIndex, $CCS_HasAimCounter, $CCS_DamageDealt, $CCS_GoesWhereAfterLinkResolves;
...
function ResetMainClassState()
{
  ...
  global $CS_NumToughnessDestroyed, $CS_NumConfidenceDestroyed, $CS_NumCostedCardsPlayed, $CS_HitCounter;
