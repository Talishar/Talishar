...
function MakeStartTurnBackup()
{
  ...
  function GetGamestateArray($handler)
  {
...
function ParseGamestate()
{
  ...
  $playerHealths = GetGamestateArray($handler);

  //Player 1
  $p1Hand = GetGamestateArray($handler);
  $p1Deck = GetGamestateArray($handler);
  $p1CharEquip = GetGamestateArray($handler);
  $p1Resources = GetGamestateArray($handler);
  $p1Arsenal = GetGamestateArray($handler);
  $p1Items = GetGamestateArray($handler);
  $p1Auras = GetGamestateArray($handler);
  $p1Discard = GetGamestateArray($handler);
  $p1Pitch = GetGamestateArray($handler);
  $p1Banish = GetGamestateArray($handler);
  $p1ClassState = GetGamestateArray($handler);
  $p1CharacterEffects = GetGamestateArray($handler);
  $p1Soul = GetGamestateArray($handler);
  $p1CardStats = GetGamestateArray($handler);
  $p1TurnStats = GetGamestateArray($handler);
  $p1Allies = GetGamestateArray($handler);
  $p1Permanents = GetGamestateArray($handler);
  $p1Settings = GetGamestateArray($handler);

  //Player 2
  $p2Hand = GetGamestateArray($handler);
  $p2Deck = GetGamestateArray($handler);
  $p2CharEquip = GetGamestateArray($handler);
  $p2Resources = GetGamestateArray($handler);
  $p2Arsenal = GetGamestateArray($handler);
  $p2Items = GetGamestateArray($handler);
  $p2Auras = GetGamestateArray($handler);
  $p2Discard = GetGamestateArray($handler);
  $p2Pitch = GetGamestateArray($handler);
  $p2Banish = GetGamestateArray($handler);
  $p2ClassState = GetGamestateArray($handler);
  $p2CharacterEffects = GetGamestateArray($handler);
  $p2Soul = GetGamestateArray($handler);
  $p2CardStats = GetGamestateArray($handler);
  $p2TurnStats = GetGamestateArray($handler);
  $p2Allies = GetGamestateArray($handler);
  $p2Permanents = GetGamestateArray($handler);
  $p2Settings = GetGamestateArray($handler);

  $landmarks = GetGamestateArray($handler);
  $winner = trim(fgets($handler));
  $firstPlayer = trim(fgets($handler));
  $currentPlayer = trim(fgets($handler));
  $currentTurn = trim(fgets($handler));
  $turn = GetGamestateArray($handler);
  $actionPoints = trim(fgets($handler));
  $combatChain = GetGamestateArray($handler);
  $combatChainState = GetGamestateArray($handler);
  $currentTurnEffects = GetGamestateArray($handler);
  $currentTurnEffectsFromCombat = GetGamestateArray($handler);
  $nextTurnEffects = GetGamestateArray($handler);
  $decisionQueue = GetGamestateArray($handler);
  $dqVars = GetGamestateArray($handler);
  $dqState = GetGamestateArray($handler);
  $layers = GetGamestateArray($handler);
  $layerPriority = GetGamestateArray($handler);
  $mainPlayer = trim(fgets($handler));
  $defPlayer = $mainPlayer == 1 ? 2 : 1;
  $lastPlayed = GetGamestateArray($handler);
  $numChainLinks = trim(fgets($handler));
  $chainLinks = array();
  for ($i = 0; $i < $numChainLinks; ++$i) {
    $chainLink = GetGamestateArray($handler);
    array_push($chainLinks, $chainLink);
  }
  $chainLinkSummary = GetGamestateArray($handler);
  ...
  $animations = GetGamestateArray($handler); //Animations
  ...
  $events = GetGamestateArray($handler); //Events
