...
function BuildMyGamestate($playerID)
{
  ...
  DoGamestateUpdate();
  $mainPlayerGamestateStillBuilt = 0;
  $myStateBuiltFor = $playerID == 1 ? 1 : ($playerID == 3 ? 1 : 2);
  $myHand = $playerID != 2 ? $p1Hand : $p2Hand;
  $myDeck = $playerID != 2 ? $p1Deck : $p2Deck;
  $myResources = $playerID != 2 ? $p1Resources : $p2Resources;
  $myCharacter = $playerID != 2 ? $p1CharEquip : $p2CharEquip;
  $myArsenal = $playerID != 2 ? $p1Arsenal : $p2Arsenal;
  $myHealth = $playerID != 2 ? $playerHealths[0] : $playerHealths[1];
  $myItems = $playerID != 2 ? $p1Items : $p2Items;
  $myAuras = $playerID != 2 ? $p1Auras : $p2Auras;
  $myDiscard = $playerID != 2 ? $p1Discard : $p2Discard;
  $myPitch = $playerID != 2 ? $p1Pitch : $p2Pitch;
  $myBanish = $playerID != 2 ? $p1Banish : $p2Banish;
  $myClassState = $playerID != 2 ? $p1ClassState : $p2ClassState;
  $myCharacterEffects = $playerID != 2 ? $p1CharacterEffects : $p2CharacterEffects;
  $mySoul = $playerID != 2 ? $p1Soul : $p2Soul;
  $myCardStats = $playerID != 2 ? $p1CardStats : $p2CardStats;
  $myTurnStats = $playerID != 2 ? $p1TurnStats : $p2TurnStats;
  $theirHand = $playerID != 2 ? $p2Hand : $p1Hand;
  $theirDeck = $playerID != 2 ? $p2Deck : $p1Deck;
  $theirResources = $playerID != 2 ? $p2Resources : $p1Resources;
  $theirCharacter = $playerID != 2 ? $p2CharEquip : $p1CharEquip;
  $theirArsenal = $playerID != 2 ? $p2Arsenal : $p1Arsenal;
  $theirHealth = $playerID != 2 ? $playerHealths[1] : $playerHealths[0];
  $theirItems = $playerID != 2 ? $p2Items : $p1Items;
  $theirAuras = $playerID != 2 ? $p2Auras : $p1Auras;
  $theirDiscard = $playerID != 2 ? $p2Discard : $p1Discard;
  $theirPitch = $playerID != 2 ? $p2Pitch : $p1Pitch;
  $theirBanish = $playerID != 2 ? $p2Banish : $p1Banish;
  $theirClassState = $playerID != 2 ? $p2ClassState : $p1ClassState;
  $theirCharacterEffects = $playerID != 2 ? $p2CharacterEffects : $p1CharacterEffects;
  $theirSoul = $playerID != 2 ? $p2Soul : $p1Soul;
  $theirCardStats = $playerID != 2 ? $p2CardStats : $p1CardStats;
  $theirTurnStats = $playerID != 2 ? $p2TurnStats : $p1TurnStats;
}
