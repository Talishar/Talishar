...
<head>
  ...
  <link rel="shortcut icon" type="image/png" href="./Images/bladeBreakIcon.png" />
</head>
  ...
  <nav>
    <div class="wrapper">
      ...
      <ul>
        ...
        <li><a href="https://reporting.fleshandbloodonline.com/FaBOnline/zzGameStats.php">Stats</a></li>
        <?php
        if (isset($_SESSION["useruid"])) {
