...
function ProcessTrigger($player, $parameter, $uniqueID, $target="-")
{
  ...
  switch ($parameter) {
    ...
    case "DYN094":
      ...
      AddDecisionQueue("SETDQCONTEXT", $player, "Choose a Hyper Driver to put a steam counter on", 1);
      AddDecisionQueue("CHOOSEMULTIZONE", $player, "<-", 1);
    ...
    case "DYN113": case "DYN114":
        ...
        AddDecisionQueue("SETDQCONTEXT", $player, "Choose if you want sink <0> with Arakni ('Sinking' a card means to put that card to the bottom of the deck)" , 1);
