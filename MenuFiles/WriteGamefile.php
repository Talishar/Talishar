<?php
  ...
  if(!function_exists("WriteGameFile"))
  {
    function WriteGameFile()
    {
      ...
      global $p1Matchups, $p2Matchups, $p1StartingLife, $p1ContentCreatorID, $p2ContentCreatorID;
      global $p1SideboardSubmitted, $p2SideboardSubmitted, $p1IsAI, $p2IsAI;
      ...
      fwrite($gameFileHandler, $p1StartingLife . "\r\n");
