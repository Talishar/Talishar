...
function ProcessImage($cardID)
{
  ...
  $cropFilename = "../crops/english/" . $cardID . "_cropped.webp";
  $cardCropsUploadedFolder = "../CardImages/media/uploaded/public/crops/english/" . $cardID . "_cropped.webp"; // !! CardImages/ to be changed for your own folder name
  $cardCropsMissingFolder = "../CardImages/media/missing/crops/english/" . $cardID . "_cropped.webp"; // !! CardImages/ to be changed for your own folder name
