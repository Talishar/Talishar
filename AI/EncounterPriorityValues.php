  ...
  switch($heroID)
  {
      case "ROGUE001":
        switch($cardID)
        {
          ...
          case "EVR183": $priority = array(0, 0.7, 0, 0, 0, 0, 0, 0.8); return $priority[$type];
          case "UPR033": $priority = array(0, 0.7, 0, 0, 0, 0.5, 0, 0); return $priority[$type];
          case "UPR042": $priority = array(0, 0, 0, 0, 0, 0, 0, 0.8); return $priority[$type];
          default: return 0;
        }
      case "ROGUE004":
        switch($cardID)
