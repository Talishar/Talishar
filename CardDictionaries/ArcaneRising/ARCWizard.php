<?php
  ...
  function ArcaneDamage($cardID)
  {
    ...
    switch($cardID)
    {
      ...
      case "UPR174": case "UPR172": case "UPR131": case "UPR129": case "UPR124": case "UPR120": return 2;
      case "UPR175": case "UPR179": case "UPR180": case "UPR181": case "UPR132": case "UPR121": return 1;
  ...
  function ArcaneBarrierChoices($playerID, $max)
  {
    ...
    for($i=0; $i<count($character); $i+=CharacterPieces())
    {
      ...
      switch($character[$i])
      {
        ...
        case "MST228": case "MST628": ++$barrierArray[1]; $total += 1; break;
        case "MST229": case "MST629": ++$barrierArray[1]; $total += 1; break;
