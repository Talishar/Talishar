...
function EVOEffectAttackModifier($cardID): int|string
{
  ...
  return match ($cardID) {
    ...
    "gigawatt_red", "gas_up_red", "quickfire_red", "re-charge_red" => 4,
    "moonshot_yellow", "gigawatt_yellow", "gas_up_yellow", "quickfire_yellow", "re-charge_yellow" => 3,
    "steel_street_hoons_blue", "big_shot_red", "burn_rubber_red", "smash_and_grab_red", "gigawatt_blue", "gas_up_blue", "quickfire_blue", "re-charge_blue", "evo_face_breaker_red_equip" => 2,
...
function EVOCombatEffectActive($cardID, $attackID)
{
  ...
  return match ($cardID) {
    ...
    "gas_up_red", "gas_up_yellow", "gas_up_blue", "quickfire_red", "quickfire_yellow", "quickfire_blue", "re-charge_red", "re-charge_yellow", "re-charge_blue" => $combatChainState[$CCS_IsBoosted],
