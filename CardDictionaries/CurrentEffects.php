...
function HVYEffectPowerModifier($cardID): int|string
{
  ...
  return match ($cardID) {
    ...
    "the_golden_son_yellow", "big_bop_blue-BUFF", "bigger_than_big_blue-BUFF", "cut_the_deck_red", "fatal_engagement_blue", "agile_engagement_red", "vigorous_engagement_red", "draw_swords_red", "edge_ahead_red-BUFF",
...
function HVYCombatEffectActive($cardID, $attackID)
{
  ...
  return match ($cardID) {
    ...
    "draw_swords_red", "draw_swords_yellow", "draw_swords_blue", "edge_ahead_red-BUFF", "edge_ahead_yellow-BUFF", "edge_ahead_blue-BUFF", "engaged_swiftblade_red",
