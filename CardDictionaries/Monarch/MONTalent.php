<?php
  ...
  function MONTalentPlayAbility($cardID, $from, $resourcesPaid, $target="-", $additionalCosts = "")
  {
    ...
    case "blinding_beam_blue":
      ...
      if ($target != "-")
        $CombatChain->Card(intval($target))->ModifyPower($amount);
      return "";
    ...
    case "howl_from_beyond_blue":
      AddCurrentTurnEffect($cardID, $currentPlayer);
      return "";
    case "spew_shadow_red":
    case "spew_shadow_yellow":
    case "spew_shadow_blue":
      switch ($cardID) {
        case "spew_shadow_red":
          $maxCost = 2;
          break;
      ...
      return "";
    case "blood_tribute_red":
    case "blood_tribute_yellow":
    case "blood_tribute_blue":
      switch ($cardID) {
        case "blood_tribute_red":
          $amount = 3;
          break;
