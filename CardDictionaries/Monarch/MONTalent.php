<?php
  ...
  function IsImmuneToBloodDebt($player)
  {
    global $CS_Num6PowBan;
      ...
      if($character[1] == 2 && ($character[0] == "MON119" || $character[0] == "MON120" || (SearchCharacterForCard($player, "CRU097") && ((SearchCurrentTurnEffects("MON119", $player)) || (SearchCurrentTurnEffects("MON120", $player))))) && GetClassState($player, $CS_Num6PowBan) > 0)
      {
        return true;
      }
      return false;
