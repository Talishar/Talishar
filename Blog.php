...
<div class="grid-even-collum">
  ...
  <div class="articles">
    ...
    <p><br>- Your deck list in limited is now sorted.
      ...
      <br>FYI: This update and the one from the last 2 days are being delayed. Mostly because the new code and BIG update for the triggers will break all the game in progress so we want to make it clean for the players. Thank you for your patience! 🙂
    </p>
  </div>
  <div class="articles">
