...
function GainLife($amount, $player, $silent=false, $preventable=true)
{
  $otherPlayer = ($player == 1 ? 2 : 1);
  $life = &GetLife($player);
  ...
  if((SearchCharacterForCard($player, "CRU140") || SearchCharacterForCard($otherPlayer, "CRU140") && $preventable) && $life > $otherLife) {
