...
function CanPlayAsInstant($cardID, $index = -1, $from = "")
{
  ...
  if (DelimStringContains($cardType, "A") && $currentPlayer == $mainPlayer && isset($combatChainState[$CCS_EclecticMag]) && $combatChainState[$CCS_EclecticMag]) return true;
...
function DoesAttackHaveGoAgain()
{
  ...
  if (SearchCurrentTurnEffects("ROS010-GOAGAIN", $mainPlayer) && $CombatChain->AttackCard()->From() != "PLAY" && $attackType == "AA") return true;
