...
{
  $devTestEvents = array("You_find_a_large_shrine", "You_find_a_large_mirror"); //Put events in here to test them. They will be the only ones to show up. Make sure you put at least 2 options
  ...
  $rareEvents = array("You_see_a_small_temple_a_ways_from_the_path", "A_radiant_woman_comes_across_your_path", "You_find_a_small_purple_chest", "You_find_an_ornate_brown_chest", "You_find_an_ornate_white_chest", "You_find_an_ornate_blue_chest", "You_find_an_ornate_red_chest", "You_find_an_ornate_green_chest", "You_see_smoke_rising_in_the_distance", "You_find_a_large_shrine", "You_find_a_large_mirror");
  $majesticEvents = array("You_find_an_ornate_purple_chest", "", "");
