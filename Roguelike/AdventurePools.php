...
{
  $devTestEvents = array("You_find_a_small_blue_chest", "You_find_a_small_purple_chest"); //Put events in here to test them. They will be the only ones to show up. Make sure you put at least 2 options
  ...
  $rareEvents = array("You_see_a_small_temple_a_ways_from_the_path", "A_radiant_woman_comes_across_your_path", "You_find_a_small_purple_chest");
