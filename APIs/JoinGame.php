...
if ($decklink != "") {
  ...
  $weaponSideboard = "";
  $totalCards = 0;
  $orderedSets = ["WTR", "ARC", "CRU", "MON", "ELE", "EVR", "UPR", "DYN", "OUT", "DVR", "RVD", "DTD", "LGS", "HER", "FAB", "TCC", "EVO", "HVY", "MST", "AKO", "ASB", "ROS", "AAZ", "TER", "AUR", "AIO"];
...
function IsCardBanned($cardID, $format, $character)
{
  ...
  if($format != "openformatcc" && $cardID == "HER123") return true; // IRA Hero CC Launch 2nd November
  if(($format != "openformatcc" && $format != "openformatblitz") && $set == "AIO") return true; // Dash Armory Deck Launch 18th November
