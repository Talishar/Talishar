<?php
  ...
  function IsPlayRestricted($cardID, &$restriction, $from="", $index=-1)
  {
    ...
    switch($cardID)
    {
      ...
      case "UPR050": return (count($combatChain) == 0 || CardType($combatChain[0]) != "AA" || (!ClassContains($combatChain[0], "NINJA", $player) && !TalentContains($combatChain[0], "DRACONIC", $player)));
