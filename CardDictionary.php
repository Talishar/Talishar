...
{
  global $CS_NumActionsPlayed, $mainPlayer, $currentPlayer, $CS_PlayIndex, $actionPoints, $layers, $combatChain;
  ...
  switch($cardID) {
    ...
    case "MST133":
      $names = "I";
      if($currentPlayer == $mainPlayer && count($combatChain) == 0 && count($layers) <= LayerPieces() && $actionPoints > 0) $names .= ",A";
      return $names;
    default: return "";
  }
}
