...
<?php echo(CreatePopup("inactivityWarningPopup", [], 1, 0, "Inactivity Warning", 1, "Interact with the screen in the next 10 seconds or you could be kicked for inactivity.")); ?>
<?php echo(CreatePopup("inactivePopup", [], 1, 0, "You are Inactive", 1, "You are inactive. Your opponent is able to claim victory. Interact with the screen to clear this.")); ?>
