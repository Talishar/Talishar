...
function DecisionQueueStaticEffect($phase, $player, $parameter, $lastResult)
{
  ...
  global $CS_ArcaneTargetsSelected, $inGameStatus, $CS_ArcaneDamageDealt, $MakeStartTurnBackup, $CCS_AttackTargetUID, $MakeStartGameBackup, $CS_DamageDealt;
  $rv = "";
  switch ($phase) {
    case "FINDINDICES":
    ...
    case "TAKEDAMAGE":
      ...
      IncrementClassState($otherPlayer, $CS_DamageDealt, $damage);
    ...
    case "SHOWSELECTEDTARGET":
      ...
      WriteLog("Targeting: " . GetMZCardLink($targetPlayer, $lastResult));
      return $lastResult;
