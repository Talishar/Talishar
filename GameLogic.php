  ...
  switch($phase) {
    case "FINDINDICES":
      ...
      switch($parameter) {
        ...
        case "EQUIP0": $rv = GetEquipmentIndices($player, 0, 0); break;
        case "EQUIP1": $rv = GetEquipmentIndices($player, 1, 0); break;
    ...
    case "SHOWSELECTEDTARGET":
      ...
      WriteLog(" targetting: " .GetMZCardLink($targetPlayer, $lastResult));
      return $lastResult;
    ...
    case "SETABILITYTYPEABILITY":
      ...
      SetClassState($player, $CS_AbilityIndex, $index);
      return $lastResult;
    case "SETABILITYTYPEINSTANT":
      $index = GetAbilityIndex($parameter, GetClassState($player, $CS_CharacterIndex), "Instant");
      SetClassState($player, $CS_AbilityIndex, $index);
      return $lastResult;
    ...
    case "MZREVEAL": return MZReveal($player, $parameter, $lastResult);
