...
function CheckImage($cardID, $isDuplicate=false)
{
  ...
  $filename2 = "../FaB-Online-React-Client/public/cardimages/" . $cardID . ".webp"; // !! FaB-Online-React-Client/ to be changed for your own folder name
  ...
  $concatFilename2 = "../FaB-Online-React-Client/public/cardsquares/" . $cardID . ".webp"; // !! FaB-Online-React-Client/ to be changed for your own folder name
  ...
  $cropFilename2 = "../FaB-Online-React-Client/public/crops/" . $cardID . "_cropped.png"; // !! FaB-Online-React-Client/ to be changed for your own folder name
